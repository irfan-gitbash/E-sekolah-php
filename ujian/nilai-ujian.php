...
if($msg == 'LULUS'){
  ...
  <i class="fa-solid fa-check"></i> SELAMAT.. Siswa dengan NIS : ' . $nis . 'berhasil lulus ujian
...
$queryNoUjian = mysqli_query($koneksi, "SELECT max(noUjian) as maxno FROM tbl_ujian");
                       ...
                       <div class="row">
                        <div class="col-4">
                          ...
                          <div class="input-group mb-2">
                              ...
                              <div class="input-group mb-2">
                                <span class="input-group-text col-2 ps-2 fw-bold">Average</span>
