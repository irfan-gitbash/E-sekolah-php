...
<div id="layoutSidenav_content">
  ...
  <div class="card-header">
    <span class="h5 my-2"><i class="fa-solid fa-list"></i> Siswa</span>
...
while($data = mysqli_fetch_array($querySiswa)){ ?>
    <tr>
      ...
      class="rounded-circle" alt="foto siswa"width="50%;"></td>
      <td><?= $data['nis']?></td>
      <td><?=$data['nama']?></td>
      <td><?=$data['kelas']?></td>
      <td><?=$data['jurusan']?></td>
      ...
      <td align="center">
        ...
        <a href="hapus-siswa.php?nis=<?=$data['nis']?>&foto<?=$data['foto']?>" class="btn btn-sm btn-danger" title="Hapus Siswa" onclick="return confirm('anda yakin mau menghapus data ini?')"><i class="fa-solid fa-trash"></i></a>
      </td>
    </tr>
<?php } ?>
  </tbody>
