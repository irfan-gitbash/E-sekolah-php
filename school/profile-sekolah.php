...
if(isset($_GET['msg'])){
  ...
  if($msg == 'notimage'){
    ...
    <i class="fa-solid fa-triangle-exclamation"></i> Update data sekolah gagal, file
  ...
  if($msg == 'oversize'){
    $alert = '<div class="alert alert-warning alert-dismissible fade show" role="alert">
    <i class="fa-solid fa-triangle-exclamation"></i> Update data sekolah gagal, Maximal ukuran gambar 1mb
    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
      <span aria-hidden="true">&times;</span>
    </button>
  </div>';
...
<div id="layoutSidenav_content">
  ...
  <div class="card-body">
    <div class="row">
        <div class="col-4 text-center px-5">
            ...
            <img src="../asset/image/Sekolah.png ?>" width="100%" alt="Gambar sekolah" class="mb-3">
    ...
    <label for="nama" class="col-sm-1 col-form-label" style="margin-left:-100px;">:</label>
  ...
  <div class="mb-3 row ">
    ...
    <label for="email" class="col-sm-1 col-form-label" style="margin-left:-100px;">:</label>
    <div class="col-sm-9" style="margin-left: -50px;">
  ...
  <div class="mb-3 row ">
    ...
    <label for="status" class="col-sm-1 col-form-label" style="margin-left:-100px;">:</label>
    <div class="col-sm-9" style="margin-left: -50px;">
  ...
  <div class="mb-3 row ">
    ...
    <label for="akreditasi" class="col-sm-1 col-form-label" style="margin-left:-100px;">:</label>
    <div class="col-sm-9" style="margin-left: -50px;">
  ...
  <div class="mb-3 row ">
    ...
    <label for="alamat" class="col-sm-1 col-form-label" style="margin-left:-100px;">:</label>
    <div class="col-sm-9" style="margin-left: -50px;">
  ...
  <div class="mb-3 row ">
    ...
    <label for="visimisi" class="col-sm-1 col-form-label" style="margin-left:-100px;">:</label>
    <div class="col-sm-9" style="margin-left: -50px;">
