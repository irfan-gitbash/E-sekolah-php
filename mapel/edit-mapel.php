...
<div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="../mapel/mapel.php">Back</a></li>
                        </ol>
                        <div class="row">
                          <div class="col-4">
                          <div class="card">
  ...
  <div class="mb-3">
    ...
    <select name="jurusan" id="jurusan" class="form-select" required>
     <?php
     $jurusan = ["Admin Perkantoran", "Akutansi Perkantoran","Teknik Komputer Jaringan"];
  ...
  <a href="mapel.php"class="btn btn-danger"><i class="fa-solid fa-xmark"></i> Cancel</a>
    </form>
  </div>
</div>
                          </div>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><?=$data['guru'] ?></td>
      <td align="center">
       <button type="button"class="btn btn-sm btn-warning rounded-0 col-10">Updated...</button>
      </td> 
    </tr>
  </tbody>
</table>
