...
?>
  ...
  <div class="row">
    ...
    <div class="col-sm-9">
      <input type="text" readonly class="form-control border-0 bg-transparent" id="nama" value=": <?= $profile['jabatan']?>"readonly></input>
    </div>
  </div>
  <div class="row">
    <label for="alamat" class="col-sm-3 col-form-label pe-0">Alamat</label>
    <div class="col-sm-9">
     <textarea  id="alamat" cols="30" rows="2" class="form-control border-0 bg-transparent"readyonly>: <?= $profile['alamat']?></textarea>
    </div>
  </div>
      </div>
    </div>
